        ...
        <form id="leave-application-form" onSubmit={saveLeaveRequest}>
          {leaveModalTab === 'leave' ? (
            <div className="row g-3">
              ...
              <div className="col-md-6"><label className="form-label">End</label><input type="date" className="form-control" value={leaveFormData.endDate} onChange={e => setLeaveFormData({ ...leaveFormData, endDate: e.target.value })} required disabled={leaveFormData.isHalfDay} /></div>
              <div className="col-12">
                <button
                  type="button"
          ...
          <div>
            ...
            <div className="row g-3">
              {balanceSummary.length === 0 && (
                <div className="col-12">
                  <div className="text-muted">No unofficial leave quota configured.</div>
                </div>
              )}
              {balanceSummary.map((item) => (
                <div key={item.type} className="col-12">
                  <div className="p-3 bg-white border rounded text-center shadow-sm h-100">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="fw-semibold text-truncate text-start" title={item.type}>{item.type}</div>
                      <div className="text-muted">{item.used}/{item.quota} used</div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center mt-2">
                      <div className="text-muted">Leaves Left</div>
